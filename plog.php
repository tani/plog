...
$CONFIG = parse_ini_file('.plogrc',true);
class Plog {
  ...
  private static function read($filename){
    if(preg_match('#\.php$#',$filename)){
      ...
      $article = Parsedown::instance()->text(file_get_contents($filename));
      $article = str_replace('<h1>',"<h1><time>$matches[0]</time> ",$article);
      self::$content .= "<article>$article</article>";
    }
  }
...
crossorigin="anonymous">
    <link rel="stylesheet" href="https://bootswatch.com/<?php echo $CONFIG['page']['theme'] ?>/bootstrap.min.css">
  </head>
  <body>
    <header>
    ...
    <footer class="container">
      ...
      Generated by <a href="https://github.com/ta2gch/plog">Plog</a>.
    </footer>
  </body>
</html>
